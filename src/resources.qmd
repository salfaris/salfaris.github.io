...
- Implemented "Variational Graph Auto-Encoders" (Kipf and Welling, 2016) in JAX for my dissertation. Source code in [this repo](https://github.com/salfaris/vgae-jax).
- Reproduced and extended "Inference Suboptimality in Variational Autoencoders" (Cremer et. al, 2018) using JAX. Built together with Basim Khajwal, Snehal Raj and Vasileios Ntogram and source code can be found in [this repo](https://github.com/ATML-2022-Group6/inference-suboptimality).