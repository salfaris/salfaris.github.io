...
description: "To pension or not to pension as a migrant. This is a common question among migrants so let's explore both these scenarios at the extremes. In particular, I'll be looking at the extreme case of contributing to pension, get the company matching but then perform an early withdrawal. This comes at a cost of a penalty, so what would it look like then?"
