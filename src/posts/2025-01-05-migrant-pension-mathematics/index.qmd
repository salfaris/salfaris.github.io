...
description: "To pension or not to pension as a migrant—this is a common question I get asked. So, let's explore both scenarios at the extremes. In particular, I'll examine the extreme case of contributing to a pension, receiving the company match, but then making an early withdrawal. Would this still be an interesting option?"
