...
Optional but try to ping your Pi. What happened to me was that I copied the wrong IP address when I was network scanning. So send three packets by running `ping -c 3 $PI_IP`.

Then ssh into your pi by running `ssh pi@$PI_IP`. If you didn't set a username and password, your username is `pi` and your password is `raspberry`. Change this after successfully ssh-ing into your Pi using the `passwd` command.
